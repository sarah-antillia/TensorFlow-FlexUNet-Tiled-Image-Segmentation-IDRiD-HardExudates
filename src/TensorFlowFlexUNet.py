...
class TensorFlowFlexUNet(TensorFlowFlexModel):
  ...
  def create_model(self): 
    ...
    print("---Encoder kernel_size   {}".format(kernel_sizes))
    ...
    for i in range(num_layers):
      ...
      #print("--- kernel_size {} dilation {}".format(kernel_size, dilation))
      #print("--- dilation {}".format(dilation))
      if i <num_layers-1:
        print("--- Encoder {} kernel_size {} dilation {}".format(i, kernel_size, dilation))
      if i == num_layers:
        print("    Bridge     kernel_size {} dilation {}".format(  kernel_size, dilation))
    ...
    for i in range(num_layers-1):
      ...
      #print("+++ dilation {}".format(dilation))
      print("+++ Decoder {} kernel_size {} dilation {}".format(i, kernel_size, dilation))
