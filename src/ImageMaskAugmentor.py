...
# ImageCategorizedMaskAugmentor.py

# 2025/06/15
#  
#barrel_distort method has been take from the following
# code in stackoverflow.com
# # https://stackoverflow.com/questions/59776772/python-opencv-how-to-apply-radial-barrel-distortion

# pincushion_distortion to train_eval_infer.config
...
# Barrel_distortion to train_eval_infer.config
...
class ImageMaskAugmentor:
  ...
  def __init__(self, config_file):
    ...
    if self.deformation:
      ...
      #You may the simgoids parameter as a list somethinkg like [8,10]
  ...
  # The following barrel_distort method has been taken from the following
  # code in stackoverflow.com
  # https://stackoverflow.com/questions/59776772/python-opencv-how-to-apply-radial-barrel-distortion
