...
class TensorFlowFlexUNet3Plus(TensorFlowFlexUNet):
  ...
  def create_model(self):
    ...
    print("=== TensorFlowFlexUNet3Plus  create ...")
    ...
    for i in range(num_filters):
      filters.append(self.base_filters * (2**i))
...
if __name__ == "__main__":
  ...
  try:
    ...
    model    = TensorFlowFlexUNet3Plus(config_file)
