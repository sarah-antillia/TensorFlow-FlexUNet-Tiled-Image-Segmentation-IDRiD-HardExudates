...
# TensorflowEfficientNetB7UNet.py
# 2024/03/30 to-arai
...
# 2025/07/07
# Modified the base class to be TensorFlowFlexUNet.
class TensorFlowFlexEfficientNetB7UNet(TensorFlowFlexUNet):
  ...
  def create_model(self):
    ...
    #           base_filters = 16, num_layers = 6):            
      ...
      if self.num_classes == 1 or self.num_classes == 2:
        ...
        final_filter_num = self.num_classes
        final_activation = 'softmax'       

      outputs = Conv2D(1, 1, padding="same", activation=final_activation)(d5)
...
if __name__ == "__main__":
  try:
    ...
    model = TensorFlowFlexEfficientNetB7UNet(config_file)
