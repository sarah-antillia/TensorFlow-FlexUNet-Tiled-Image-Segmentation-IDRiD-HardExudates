...
# 2025/07/07 T.Arai
# Modified the base class name to be TensorFlexUNet.
class TensorFlowFlexSharpUNet (TensorFlowFlexUNet):
  ...
  def create_model(self):
    ...
    image_size = (self.image_width, self.image_height, self.image_channels)    
    ...
    conv10 = Conv2D(self.num_classes, (1, 1), activation= activation)(conv)
...
if __name__ == "__main__":
  try:
    ...
    model    = TensorFlowFlexSharpUNet(config_file)
