...
class TensorFlowFlexTransUNet(TensorFlowFlexUNet) :
  ...
  def create_model(self):
      #, num_classes, image_height, image_width, image_channels,
      #         base_filters = 16, num_layers = 6):
      print("==== TensorFlowFlexTransUNet.create ")
      input_size = (self.image_width, self.image_height, self.image_channels)
      ...
      OUT = CONV_output(X, self.num_classes, kernel_size=1, activation=output_activation, name='{}_output'.format(self.name))
...
if __name__ == "__main__":
  try:
    ...
    model = TensorFlowFlexTransUNet(config_file)
