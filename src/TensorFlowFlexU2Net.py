...
#2025/07/07
# Modified the base name to be TensorFlowFlexUNet

class TensorFlowFlexU2Net(TensorFlowFlexUNet) :
  ...
  def create_model(self):
    ...
    print("=== TensorFlowFlexU2Net.create")
...
if __name__ == "__main__":
  try:
    ...
    model = TensorFlowFlexU2Net(config_file)
