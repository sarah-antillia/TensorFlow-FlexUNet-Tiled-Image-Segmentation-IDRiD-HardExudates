...
# 2025/07/07 T.Arai
# Modified the base class name to be  TensorFlowFlexModel.

# Define TensorflowMultiResUNet class as a subclass of TensorflowUNet
# Modified the base class name to be  TensorFlowFlexModel
class TensorFlowFlexMultiResUNet(TensorFlowFlexUNet):
  ...
  def create_model(self):
    ...
    num_classes  = self.config.get(ConfigParser.MODEL, "num_classes", dvalue=2)
...
if __name__ == "__main__":
  try:
    ...
    model    = TensorFlowFlexMultiResUNet(config_file)
