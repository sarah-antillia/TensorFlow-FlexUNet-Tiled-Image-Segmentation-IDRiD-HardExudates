...
class TensorFlowFlexSwinUNet(TensorFlowFlexUNet) :
  ...
  def swin_unet_2d_base(self, input_tensor, filter_num_begin, depth, stack_num_down, stack_num_up, 
    ...
    '''
    print("--- TensorRlowSwinUnet.swin_unet_2d_base ---")
  ...
  def create_model(self):
    print("=== create TensorFlowFlexSwinUNet")
    ...
    OUT = Conv2D(self.num_classes, kernel_size=1, use_bias=False, activation=activation)(X)
...
if __name__ == "__main__":
  try:
    ...
    model = TensorFlowFlexSwinUNet(config_file)
